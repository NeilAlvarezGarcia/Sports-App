...
import { palette } from '../../constants/theme/pallete';
import { startAnimation, stopAnimation } from '../../utils/animation';

const DEFAULT_VALUE = palette.white;

export function LoadingState({
  color = DEFAULT_VALUE,
  size = 18,
  ...props
}: LoadingStateProps): ReactElement | null {
  ...
  return (
    <svg width={size} height={size} x='0px' y='0px' viewBox='0 0 40 40' {...props}>
